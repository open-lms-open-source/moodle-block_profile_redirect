...
non dispongano di un valore valido nel loro campo profilo. Questo campo deve avere un nome completo, un nome abbreviato o un numero ID del corso basato sul valore nel menu a discesa del campo del corso';
