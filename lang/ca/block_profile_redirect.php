...
$string['descriptiontxt'] = '<p>La funció del bloc de redirecció de perfil és redirigir l\'usuari des de la pàgina principal del lloc o una pàgina El meu Moodle que contingui el bloc a
un curs nou. Aquest curs nou on es redirigeix l\'usuari es basa en si un valor del camp de perfil coincideix amb un valor del nom complet, el nom curt o el número d\'ID d\'un curs, segons les configuracions del lloc que es mostren a continuació.</p>
...
El meu Moodle. Per fer-ho, seguiu els passos següents:
<ol>
<li>Aneu a la pàgina principal, activeu l\'edició i, al bloc desplegable &quot;Afegeix un bloc&quot;, seleccioneu Redirecció de perfil.</li>
<li>Un cop afegit el bloc, es redirigiran tots els usuaris al curs especificat al seu camp de perfil, o bé al curs predeterminat si
no tenen cap valor vàlid al perfil.</li>
</ol>
</p>';
