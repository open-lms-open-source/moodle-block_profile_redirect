...
un curs nou. Aquest curs nou on es redirigeix l\'usuari es basa en si el valor d\'un camp del perfil coincideix amb un valor de nom complet, nom curt o número d\'ID d\'un curs, segons les configuracions del lloc que es mostren a continuació.</p>
...
El meu Moodle. Per fer-ho, seguiu aquests passos:
<ol>
