...
un nouveau cours. Le nouveau cours vers lequel l\'utilisateur est redirigé est basé sur une valeur dans un champ de profil correspondant à une valeur dans le nom complet, le nom court ou le numéro d\'identification du cours, selon les configurations du site ci-dessous.</p>
...
aucune information valide dans le champ de leur profil. Ce champ doit contenir le nom complet, le nom abrégé ou l\'identifiant du cours, en fonction de la valeur figurant dans la liste déroulante du champ du cours.';
